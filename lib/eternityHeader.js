...
function setSearchExpand(component) {
  ...
  const searchClose = component.querySelector('#searchClose');
  ...
  const rightMenuFirstItem = component.querySelector('.right .centered_menu .headphones-link');
  ...
  constructor() {
    ...
    fetch(`${ETERNITY_BASE_URL}/lib/eternityHeader.html`)
      ...
      .then(() => {
        ...
        const headerHeight = shadow.getElementById('main_header').offsetHeight;
