...
// ✅ Função que carrega mapa pela localização do usuário automaticamente
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        const query = `Church Near ${lat},${lng}`;
      ...
      (error) => {
        console.log(
          "Erro ao obter localização, tente buscar por CEP. \n",
          error
        );
      }
    );
...
// ✅ Função que busca pelo CEP digitado
function searchMap() {
...
// 🔥 Evento para botão de busca manual
...
// 🚀 Carrega o mapa automaticamente com a localização ao abrir o site
window.addEventListener("load", loadMapWithLocation);
